      ...
      <section className="featured featured-display">
        <div className="section-content">
          ...
          <ul role="list" className="section-tiles">
            <li key="1" role="listitem" className="tile-item item-hero">
              <div className="tile tile-hero" aria-label="">
                ...
                <div className="tile__description" aria-hidden="true">
                  ...
                  <Link
                    to={featured.link ?? "/"}
                    className="button art-page-link"
                    target="_blank"
        ...
        <div className="section-content">
          ...
          <ul role="list" className="section-tiles">
            {gallery.map((artpiece, idx) => (
              <li key={idx} role="listitem" className="tile-item item-2up">
                <div className="tile tile-2up" aria-label="">
                  <div className="tile__media" aria-hidden="true">
                    {artpiece.preview}
                  </div>
                  <div className="tile__description" aria-hidden="true">
